//=================================================================================================
/*!
 *  \file src/povray/SpottedNormal.cpp
...
//*************************************************************************************************
/*!\brief Creating a POV-Ray spotted normal.
 *
 * \param depth The depth of the spotted effect \f$ [0..1] \f$.
 * \exception std::invalid_argument Invalid depth value.
 *
 * This constructor creates a POV-Ray spotted normal. The depth parameter for the spotted normal
 * has to be in the range from 0 to 1, inclusive. Otherwise, a \a std::invalid_argument exception
 * is thrown.
 */
SpottedNormal::SpottedNormal( real depth )
