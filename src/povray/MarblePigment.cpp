//=================================================================================================
/*!
 *  \file src/povray/MarblePigment.cpp
...
//*************************************************************************************************
/*!\brief Creating a marble pigment according to the given color map.
 *
 * \param colormap The color map for the marble pigment.
 *
 * This constructor creates a marble pigment using the given color map.
 */
