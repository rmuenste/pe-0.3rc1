...
- [feat3-pe-frozen-field-coupling.md](feat3-pe-frozen-field-coupling.md): FEAT3+PE combined build, detailed compile/run instructions, and the `dbg-parti-velocity-eval` coupled debug app.
