//=================================================================================================
/*!
 *  \file pe/core/configuration/DEMSolverObsolete.h
 *  \brief Specialization of the Configuration class template for the old Discrete Element solver
 *
...
#ifndef _PE_CORE_CONFIGURATION_DEMSOLVEROBSOLETE_H_
#define _PE_CORE_CONFIGURATION_DEMSOLVEROBSOLETE_H_
...
//*************************************************************************************************
/*! \cond PE_INTERNAL */
/*!\brief Specialization of the configuration for the discrete element solver.
 * \ingroup core
 *
 * This specialization of the Configuration class handles the special case that the discrete
 * element solver doesn't require a batch generator. Therefore the SingleBatch algorithm is
...
struct Configuration<CD,FD,BG,response::DEMSolverObsolete>
{
public:
   //**Type definitions****************************************************************************
   typedef Configuration<CD,FD,batches::SingleBatch,response::DEMSolverObsolete>  Config;  //!< Type of this configuration.
