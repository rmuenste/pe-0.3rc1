...
#ifndef _PE_CORE_CONFIGURATION_HARDCONTACTANDFLUID_H_
#define _PE_CORE_CONFIGURATION_HARDCONTACTANDFLUID_H_
...
struct Configuration<CD,FD,BG,response::HardContactAndFluid>
{
public:
   //**Type definitions****************************************************************************
   typedef Configuration<CD,FD,batches::SingleBatch,response::HardContactAndFluid>  Config;  //!< Type of this configuration.
