//=================================================================================================
/*!
 *  \file pe/core/configuration/HardContactLubricated.h
 *  \brief Specialization of the Configuration class template for the hard contact solvers with lubrication
 *
 *  Copyright (C) 2012 Tobias Preclik
 *  Adaptation: 2023 Raphael Münster
 *
...
#ifndef _PE_CORE_CONFIGURATION_HARDCONTACTLUBRICATED_H_
#define _PE_CORE_CONFIGURATION_HARDCONTACTLUBRICATED_H_
...
struct Configuration<CD,FD,BG,response::HardContactLubricated>
{
public:
   //**Type definitions****************************************************************************
   typedef Configuration<CD,FD,batches::SingleBatch,response::HardContactLubricated>  Config;  //!< Type of this configuration.
