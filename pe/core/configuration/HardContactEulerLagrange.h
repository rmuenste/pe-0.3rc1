//=================================================================================================
/*!
 *  \file pe/core/configuration/HardContactEulerLagrange.h
...
#ifndef _PE_CORE_CONFIGURATION_HARDCONTACTEULERLAGRANGE_H_
#define _PE_CORE_CONFIGURATION_HARDCONTACTEULERLAGRANGE_H_
...
struct Configuration<CD,FD,BG,response::HardContactEulerLagrange>
{
public:
   //**Type definitions****************************************************************************
   typedef Configuration<CD,FD,batches::SingleBatch,response::HardContactEulerLagrange>  Config;  //!< Type of this configuration.
