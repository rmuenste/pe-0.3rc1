//=================================================================================================
/*!
 *  \file pe/core/configuration/HardContactSemiImplicitTimesteppingSolvers.h
 *  \brief Specialization of the Configuration class template for the hard contact solvers
 *
...
#ifndef _PE_CORE_CONFIGURATION_HARDCONTACTSEMIIMPLICITTIMESTEPPINGSOLVERS_H_
#define _PE_CORE_CONFIGURATION_HARDCONTACTSEMIIMPLICITTIMESTEPPINGSOLVERS_H_
...
//*************************************************************************************************
/*! \cond PE_INTERNAL */
/*!\brief Specialization of the configuration for the hard contact solvers.
 * \ingroup core
 *
 * This specialization of the Configuration class handles the special case that the hard contact
 * timestepping solvers do not require a batch generator. Therefore the SingleBatch algorithm is
 * specifically chosen as batch generation algorithm, since this algorithm does not impose
 * additional data members or functionality to both rigid bodies and contacts.
 */
template< template<typename> class CD    // Type of the coarse collision detection algorithm
        , typename FD                    // Type of the fine collision detection algorithm
        , template<typename> class BG >  // Type of the batch generation algorithm
struct Configuration<CD,FD,BG,response::HardContactSemiImplicitTimesteppingSolvers>
{
public:
   //**Type definitions****************************************************************************
   typedef Configuration<CD,FD,batches::SingleBatch,response::HardContactSemiImplicitTimesteppingSolvers>  Config;  //!< Type of this configuration.
