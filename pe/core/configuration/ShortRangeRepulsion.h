//=================================================================================================
/*!
 *  \file pe/core/configuration/ShortRangeRepulsion.h
 *  \brief Specialization of the Configuration class template for the ShortRangeRepulsion solver
 *
 *  Copyright (C) 2024 Raphael Münster
 *
...
#ifndef _PE_CORE_CONFIGURATION_SHORTRANGEREPULSION_H_
#define _PE_CORE_CONFIGURATION_SHORTRANGEREPULSION_H_
...
//*************************************************************************************************
/*! \cond PE_INTERNAL */
/*!\brief Specialization of the configuration for the short-range repulsion solver.
 * \ingroup core
 *
 * This specialization of the Configuration class handles the special case that the
 * ShortRangeRepulsion solver doesn't require a batch generator. Therefore the SingleBatch
 * algorithm is specifically chosen, since it does not impose additional data members or
 * functionality to rigid bodies and contacts.
 */
template< template<typename> class CD    // Type of the coarse collision detection algorithm
        , typename FD                    // Type of the fine collision detection algorithm
        , template<typename> class BG >  // Type of the batch generation algorithm
struct Configuration<CD,FD,BG,response::ShortRangeRepulsion>
{
public:
   //**Type definitions****************************************************************************
   typedef Configuration<CD,FD,batches::SingleBatch,response::ShortRangeRepulsion>  Config;  //!< Type of this configuration.
