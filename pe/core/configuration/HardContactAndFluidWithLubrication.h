//=================================================================================================
/*!
 *  \file pe/core/configuration/HardContactAndFluidWithLubrication.h
...
struct Configuration<CD,FD,BG,response::HardContactAndFluidWithLubrication>
{
public:
   //**Type definitions****************************************************************************
   typedef Configuration<CD,FD,batches::SingleBatch,response::HardContactAndFluidWithLubrication>  Config;  //!< Type of this configuration.
