//=================================================================================================
/*!
 *  \file pe/core/configuration/DEMSolver.h
 *  \brief Specialization of the Configuration class template for the DEM solver
 *
...
#ifndef _PE_CORE_CONFIGURATION_DEMSOLVER_H_
#define _PE_CORE_CONFIGURATION_DEMSOLVER_H_
...
//=================================================================================================
//
//  SPECIALIZATION FOR THE DEM SOLVER
//
//=================================================================================================

//*************************************************************************************************
/*! \cond PE_INTERNAL */
/*!\brief Specialization of the configuration for the DEM solver.
 * \ingroup core
 *
 * This specialization of the Configuration class handles the special case that the DEM solver
 * doesn't require a batch generator. Therefore the SingleBatch algorithm is
...
struct Configuration<CD,FD,BG,response::DEMSolver>
{
public:
   //**Type definitions****************************************************************************
   typedef Configuration<CD,FD,batches::SingleBatch,response::DEMSolver>  Config;  //!< Type of this configuration.
