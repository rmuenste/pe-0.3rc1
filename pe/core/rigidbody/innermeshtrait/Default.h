//=================================================================================================
/*!
 *  \file pe/core/rigidbody/InnerMeshtrait/Default.h
 *  \brief Header file for the default implementation of the InnerMeshTrait class template.
 *
...
#ifndef _PE_CORE_RIGIDBODY_INNERMESHTRAIT_DEFAULT_H_
#define _PE_CORE_RIGIDBODY_INNERMESHTRAIT_DEFAULT_H_
 ...
 * \ingroup InnerMesh
 *
 * The InnerMeshBaseTrait class template is a customization class for the triangle mesh geometry. Its main
...
class InnerMeshTrait : public InnerMeshBase
{
protected:
   //**Type definitions****************************************************************************
   typedef InnerMeshBase  Parent;  //!< The type of the parent class.
   //**********************************************************************************************

   //**Constructor*********************************************************************************
   /*!\name Constructor */
   //@{
   explicit InnerMeshTrait( id_t sid, id_t uid, const Vec3& gpos,
...
//*************************************************************************************************
/*!\brief Default implementation of the InnerMeshTrait constructor.
 *
 ...
 */
template< typename C >  // Type of the configuration
InnerMeshTrait<C>::InnerMeshTrait( id_t sid, id_t uid, const Vec3& gpos,
                                 const Vertices& vertices, const IndicesLists& faceIndices,
                                 MaterialID material, bool visible )
...
//*************************************************************************************************
/*!\brief Default implementation of the InnerMeshTrait destructor.
 */
template< typename C >  // Type of the configuration
InnerMeshTrait<C>::~InnerMeshTrait()
{}
//*************************************************************************************************
 ...
 */
template< typename C >  // Type of the configuration
void InnerMeshTrait<C>::move( real dt )
{
