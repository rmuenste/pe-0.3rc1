//=================================================================================================
/*!
 *  \file pe/core/rigidbody/boxtrait/Default.h
 *  \brief Header file for the default implementation of the BoxTrait class template.
 *
...
#ifndef _PE_CORE_RIGIDBODY_BOXTRAIT_DEFAULT_H_
#define _PE_CORE_RIGIDBODY_BOXTRAIT_DEFAULT_H_
...
//*************************************************************************************************
/*!\brief Box customization class for the collision response.
 * \ingroup box
 *
 * The BoxTrait class template is a customization class for the box geometry. Its main
 * purpose is the customization of the Box class for the selected collision response
 * algorithm (see pe::pe_CONSTRAINT_SOLVER).
 */
template< typename C >  // Type of the configuration
class BoxTrait : public BoxBase
{
protected:
   //**Type definitions****************************************************************************
 ...
 */
template< typename C >  // Type of the configuration
BoxTrait<C>::BoxTrait( id_t sid, id_t uid, const Vec3& gpos,
                       const Vec3& lengths, MaterialID material, bool visible )
...
//*************************************************************************************************
/*!\brief Default implementation of the BoxTrait destructor.
 */
template< typename C >  // Type of the configuration
BoxTrait<C>::~BoxTrait()
{}
...
void BoxTrait<C>::move( real dt )
{
   ...
   // Moving the box according to the acting forces (don't move a sleeping box)
   if( awake_ ) {
      if( !fixed_ ) {
