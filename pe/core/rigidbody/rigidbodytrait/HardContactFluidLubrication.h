//=================================================================================================
/*!
 *  \file pe/core/rigidbody/rigidbodytrait/HardContactFluidLubrication.h
...
#ifndef _PE_CORE_RIGIDBODY_RIGIDBODYTRAIT_HARDCONTACTFLUIDLUBRICATION_H_
#define _PE_CORE_RIGIDBODY_RIGIDBODYTRAIT_HARDCONTACTFLUIDLUBRICATION_H_
...
#    pragma message("pe: HardContactFluidLubrication RigidBodyTrait is deprecated; use HardContactLubricated")
#  endif
#endif
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
RigidBodyTrait< C<CD,FD,BG,response::HardContactFluidLubrication> >::RigidBodyTrait( BodyID body )
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
RigidBodyTrait< C<CD,FD,BG,response::HardContactFluidLubrication> >::~RigidBodyTrait()
{}
//*************************************************************************************************
