//=================================================================================================
/*!
 *  \file pe/core/rigidbody/spheretrait/ConeFrictionSolver.h
 *  \brief Specialization of the EllipsoidTrait class template for the cone friction solver
 *
...
#ifndef _PE_CORE_RIGIDBODY_ELLIPSOIDTRAIT_CONEFRICTIONSOLVER_H_
#define _PE_CORE_RIGIDBODY_ELLIPSOIDTRAIT_CONEFRICTIONSOLVER_H_
...
class EllipsoidTrait< C<CD,FD,BG,response::ConeFrictionSolver> > : public EllipsoidBase
{
protected:
   //**Type definitions****************************************************************************
...
//*************************************************************************************************
/*!\brief Constructor for the ConeFrictionSolver specialization of the EllipsoidTrait class template.
 *
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
EllipsoidTrait< C<CD,FD,BG,response::ConeFrictionSolver> >::EllipsoidTrait( id_t sid, id_t uid, const Vec3& gpos,
                                                                      real radius, MaterialID material, bool visible )
...
//*************************************************************************************************
/*!\brief Destructor for the ConeFrictionSolver specialization of the EllipsoidTrait class template.
 */
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        , typename FD                                           // Type of the fine collision detection algorithm
        , template<typename> class BG                           // Type of the batch generation algorithm
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
EllipsoidTrait< C<CD,FD,BG,response::ConeFrictionSolver> >::~EllipsoidTrait()
{}
//*************************************************************************************************
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
void EllipsoidTrait< C<CD,FD,BG,response::ConeFrictionSolver> >::move( real dt )
{
