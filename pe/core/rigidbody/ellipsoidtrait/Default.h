 ...
 *  \brief Header file for the default implementation of the EllipsoidTrait class template.
 *
...
#ifndef _PE_CORE_RIGIDBODY_ELLIPSOIDTRAIT_DEFAULT_H_
#define _PE_CORE_RIGIDBODY_ELLIPSOIDTRAIT_DEFAULT_H_
...
//*************************************************************************************************
/*!\brief Ellipsoid customization class for the collision response.
 * \ingroup sphere
 *
 * The EllipsoidTrait class template is a customization class for the sphere geometry.
 * Its main purpose is the customization of the Ellipsoid class for the selected collision
 * response algorithm (see pe::pe_CONSTRAINT_SOLVER).
 */
template< typename C >  // Type of the configuration
class EllipsoidTrait : public EllipsoidBase
{
protected:
   //**Type definitions****************************************************************************
...
//*************************************************************************************************
/*!\brief Default implementation of the EllipsoidTrait constructor.
 *
...
//*************************************************************************************************
/*!\brief Default implementation of the EllipsoidTrait destructor.
 */
template< typename C >  // Type of the configuration
EllipsoidTrait<C>::~EllipsoidTrait()
{}
//*************************************************************************************************
 ...
 */
template< typename C >  // Type of the configuration
void EllipsoidTrait<C>::move( real dt )
{
