//=================================================================================================
/*!
 *  \file pe/core/rigidbody/planetrait/DEMSolverObsolete.h
 *  \brief Specialization of the PlaneTrait class template for the discrete element solver
 *
...
#ifndef _PE_CORE_RIGIDBODY_PLANETRAIT_DEMSOLVEROBSOLETE_H_
#define _PE_CORE_RIGIDBODY_PLANETRAIT_DEMSOLVEROBSOLETE_H_
...
class PlaneTrait< C<CD,FD,BG,response::DEMSolverObsolete> > : public PlaneBase
{
protected:
   //**Type definitions****************************************************************************
...
//*************************************************************************************************
/*!\brief Constructor for the DEMSolverObsolete specialization of the PlaneTrait class template.
 *
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
PlaneTrait< C<CD,FD,BG,response::DEMSolverObsolete> >::PlaneTrait( id_t sid, id_t uid, const Vec3& gpos, const Vec3& normal,
                                                           real d, MaterialID material, bool visible )
...
//*************************************************************************************************
/*!\brief Destructor for the DEMSolverObsolete specialization of the PlaneTrait class template.
 */
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        , typename FD                                           // Type of the fine collision detection algorithm
        , template<typename> class BG                           // Type of the batch generation algorithm
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
PlaneTrait< C<CD,FD,BG,response::DEMSolverObsolete> >::~PlaneTrait()
{}
//*************************************************************************************************
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
void PlaneTrait< C<CD,FD,BG,response::DEMSolverObsolete> >::move( real dt )
{
   ...
   // Note: Removing all attached contacts is not necessary here
   // Note: Planes cannot be remote - since they are infinitely large they are required to be global objects

   // Position update of the object unless it is sleeping
   if( awake_ ) {
      // Note: Planes are always fixed since they are infinite - thus applied forces, torques or gravity never have an influence on planes
