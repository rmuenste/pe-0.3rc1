//=================================================================================================
/*!
 *  \file pe/core/rigidbody/capsuletrait/BoxFrictionSolver.h
 *  \brief Specialization of the CapsuleTrait class template for the box friction solver
 *
...
#ifndef _PE_CORE_RIGIDBODY_CAPSULETRAIT_BOXFRICTIONSOLVER_H_
#define _PE_CORE_RIGIDBODY_CAPSULETRAIT_BOXFRICTIONSOLVER_H_
...
class CapsuleTrait< C<CD,FD,BG,response::BoxFrictionSolver> > : public CapsuleBase
{
protected:
   //**Type definitions****************************************************************************
...
//*************************************************************************************************
/*!\brief Constructor for the BoxFrictionSolver specialization of the CapsuleTrait class template.
 *
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
CapsuleTrait< C<CD,FD,BG,response::BoxFrictionSolver> >::CapsuleTrait( id_t sid, id_t uid, const Vec3& gpos, real radius,
                                                                       real length, MaterialID material, bool visible )
...
//*************************************************************************************************
/*!\brief Destructor for the BoxFrictionSolver specialization of the CapsuleTrait class template.
 */
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        , typename FD                                           // Type of the fine collision detection algorithm
        , template<typename> class BG                           // Type of the batch generation algorithm
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
CapsuleTrait< C<CD,FD,BG,response::BoxFrictionSolver> >::~CapsuleTrait()
{}
//*************************************************************************************************
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  , template<typename,typename,typename> class  // Template signature of the collision response algorithm
                  > class C >                                   // Type of the configuration
void CapsuleTrait< C<CD,FD,BG,response::BoxFrictionSolver> >::move( real dt )
{
