//=================================================================================================
/*!
 *  \file pe/core/response/mpiencoder/DEMSolverObsolete.h
 *  \brief Specialization of the MPIEncoder class template for the discrete element solver
 *
...
#ifndef _PE_CORE_RESPONSE_MPIENCODER_DEMSOLVEROBSOLETE_H_
#define _PE_CORE_RESPONSE_MPIENCODER_DEMSOLVEROBSOLETE_H_
...
#include <pe/core/response/mpiencoder/Default.h>
 ...
 * \ingroup mpi
 *
 * This specialization of the MPIEncoder class template adapts the MPI encoder to the
...
class MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >
{
public:
   //**Type definitions****************************************************************************
...
inline void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeBody( SB& buffer, ConstBodyID b, const Vec3& offset )
{
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeBody( SB& buffer, ConstBodyID b, const Vec3& offset, bool superordinate )
{
   switch( b->getType() ) {
      case sphereType:
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
inline void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeSphere( SB& buffer, ConstSphereID s, const Vec3& offset )
{
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeSphere( SB& buffer, ConstSphereID s, const Vec3& offset, bool superordinate )
{
   // Encoding the sphere primitive
   ...
   if( superordinate ) {
      ...
      marshal( buffer, s->getLinearAcc() );            // Encoding the linear acceleration
      marshal( buffer, s->getAngularAcc() );           // Encoding the angular acceleration
   }
}
//*************************************************************************************************
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
inline void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeBox( SB& buffer, ConstBoxID b, const Vec3& offset )
{
   ...
   // Checking the global and fixed flag and the locality of the box primitive
   ...
   // Checking the fixed flag of the box primitive
   pe_INTERNAL_ASSERT( b->isFixed(), "Invalid unfixed box primitive detected" );
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeBox( SB& buffer, ConstBoxID b, const Vec3& offset, bool superordinate )
{
   // Encoding the box primitive
   ...
   if( superordinate ) {
      ...
      marshal( buffer, b->getLinearAcc() );         // Encoding the linear acceleration
      marshal( buffer, b->getAngularAcc() );        // Encoding the angular acceleration
   }
}
//*************************************************************************************************
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
inline void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeCapsule( SB& buffer, ConstCapsuleID c, const Vec3& offset )
{
   ...
   // Checking the fixed flag of the capsule primitive
   pe_INTERNAL_ASSERT( c->isFixed(), "Invalid unfixed capsule primitive detected" );
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeCapsule( SB& buffer, ConstCapsuleID c, const Vec3& offset, bool superordinate )
{
   // Encoding the capsule primitive
   ...
   if( superordinate ) {
      ...
      marshal( buffer, c->getLinearAcc() );             // Encoding the linear acceleration
      marshal( buffer, c->getAngularAcc() );            // Encoding the angular acceleration
   }
}
//*************************************************************************************************
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
inline void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeCylinder( SB& buffer, ConstCylinderID c, const Vec3& offset )
{
   ...
   // Checking the fixed flag of the cylinder primitive
   pe_INTERNAL_ASSERT( c->isFixed(), "Invalid unfixed cylinder primitive detected" );
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeCylinder( SB& buffer, ConstCylinderID c, const Vec3& offset, bool superordinate )
{
   // Encoding the cylinder primitive
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
inline void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeUnion( SB& buffer, ConstUnionID u, const Vec3& offset )
{
   // Checking whether the cylinder is contained in another rigid body
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeUnion( SB& buffer, ConstUnionID u, const Vec3& offset, bool superordinate )
{
   ...
   if( superordinate ) {
      ...
      marshal( buffer, u->getLinearAcc() );           // Encoding the linear acceleration
      marshal( buffer, u->getAngularAcc() );          // Encoding the angular acceleration
   }

   buffer << u->size();                      // Encoding the number of contained bodies
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeUpdate( SB& buffer, ConstBodyID b, const Vec3& offset )
{
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeAttachable( SB& buffer, ConstAttachableID a )
{
   switch( a->getType() ) {
      case gravityType:
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeGravity( SB& buffer, ConstGravityID g )
{
...
template< template<typename> class CD                           // Type of the coarse collision detection algorithm
        ...
        , template< template<typename> class                    // Template signature of the coarse collision detection algorithm
                  ...
                  > class C >                                   // Type of the configuration
template< typename SB >                                         // Type of the send buffer
void MPIEncoder< C<CD,FD,BG,response::DEMSolverObsolete> >::encodeSpring( SB& buffer, ConstSpringID s )
{
