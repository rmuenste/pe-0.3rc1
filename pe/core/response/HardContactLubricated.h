//=================================================================================================
/*!
 *  \file pe/core/response/HardContactLubricated.h
 *  \brief Collision response solver for hard contact problems with lubrication support
 *
...
#ifndef _PE_CORE_RESPONSE_HARDCONTACTLUBRICATED_H_
#define _PE_CORE_RESPONSE_HARDCONTACTLUBRICATED_H_
...
class HardContactLubricated : private NonCopyable
{
public:
