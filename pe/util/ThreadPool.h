...
#ifndef _PE_UTIL_THREADPOOL_THREADPOOL_H_
#define _PE_UTIL_THREADPOOL_THREADPOOL_H_
...
#include <pe/util/threadpool/FuncWrapper.h>
#include <pe/util/threadpool/TaskID.h>
#include <pe/util/threadpool/TaskQueue.h>
 ...
 * \ingroup util
 *
 * The \b pe engine offers the capability to either create individual threads for specific
...
{
   pe_STATIC_ASSERT( boost::function_traits<Callable()>::arity == 1 );
   pe_STATIC_ASSERT( boost::is_void< typename boost::result_of<Callable()>::type >::value );
...
{
   pe_STATIC_ASSERT( boost::function_traits<Callable()>::arity == 2 );
   pe_STATIC_ASSERT( boost::is_void< typename boost::result_of<Callable()>::type >::value );
...
{
   pe_STATIC_ASSERT( boost::function_traits<Callable()>::arity == 3 );
   pe_STATIC_ASSERT( boost::is_void< typename boost::result_of<Callable()>::type >::value );
...
{
   pe_STATIC_ASSERT( boost::function_traits<Callable()>::arity == 4 );
   pe_STATIC_ASSERT( boost::is_void< typename boost::result_of<Callable()>::type >::value );
...
{
   pe_STATIC_ASSERT( boost::function_traits<Callable()>::arity == 5 );
   pe_STATIC_ASSERT( boost::is_void< typename boost::result_of<Callable()>::type >::value );
