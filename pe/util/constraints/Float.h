//=================================================================================================
/*!
 *  \file pe/util/constraints/Float.h
...
#ifndef _PE_UTIL_CONSTRAINTS_FLOAT_H_
#define _PE_UTIL_CONSTRAINTS_FLOAT_H_
 ...
 * is created.
 */
#define pe_CONSTRAINT_MUST_BE_FLOAT_TYPE(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_BE_FLOAT_TYPE_FAILED< pe::IsFloat<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_BE_FLOAT_TYPE_TYPEDEF, __LINE__ )
//*************************************************************************************************
 ...
 * created.
 */
#define pe_CONSTRAINT_MUST_NOT_BE_FLOAT_TYPE(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_NOT_BE_FLOAT_TYPE_FAILED< !pe::IsFloat<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_NOT_BE_FLOAT_TYPE_TYPEDEF, __LINE__ )
//*************************************************************************************************
