//=================================================================================================
/*!
 *  \file pe/util/constraints/TypeRestriction.h
...
#ifndef _PE_UTIL_CONSTRAINTS_TYPERESTRICTION_H_
#define _PE_UTIL_CONSTRAINTS_TYPERESTRICTION_H_
 ...
 * error is created.
 */
#define pe_CONSTRAINT_SOFT_TYPE_RESTRICTION(T,TYPELIST) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_SOFT_TYPE_RESTRICTION_FAILED< pe::ContainsRelated<TYPELIST,T>::value >::value > \
      pe_JOIN( CONSTRAINT_SOFT_TYPE_RESTRICTION_TYPEDEF, __LINE__ )
//*************************************************************************************************
 ...
 * error is created.
 */
#define pe_CONSTRAINT_TYPE_RESTRICTION(T,TYPELIST) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_TYPE_RESTRICTION_FAILED< pe::Contains<TYPELIST,T>::value >::value > \
      pe_JOIN( CONSTRAINT_TYPE_RESTRICTION_TYPEDEF, __LINE__ )
//*************************************************************************************************
