//=================================================================================================
/*!
 *  \file pe/util/constraints/Void.h
...
#ifndef _PE_UTIL_CONSTRAINTS_VOID_H_
#define _PE_UTIL_CONSTRAINTS_VOID_H_
 ...
 */
#define pe_CONSTRAINT_MUST_BE_VOID(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_BE_VOID_FAILED< pe::IsVoid<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_BE_VOID_TYPEDEF, __LINE__ )
//*************************************************************************************************
 ...
 */
#define pe_CONSTRAINT_MUST_NOT_BE_VOID(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_NOT_BE_VOID_FAILED< !pe::IsVoid<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_NOT_BE_VOID_TYPEDEF, __LINE__ )
//*************************************************************************************************
