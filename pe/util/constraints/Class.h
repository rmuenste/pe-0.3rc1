//=================================================================================================
/*!
 *  \file pe/util/constraints/Class.h
...
#ifndef _PE_UTIL_CONSTRAINTS_CLASS_H_
#define _PE_UTIL_CONSTRAINTS_CLASS_H_
...
#include <pe/util/typetraits/IsClass.h>
 ...
 * error is created.
 */
#define pe_CONSTRAINT_MUST_BE_CLASS_TYPE(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_BE_CLASS_FAILED< pe::IsClass<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_BE_CLASS_TYPEDEF, __LINE__ )
//*************************************************************************************************
 ...
 * error is created.
 */
#define pe_CONSTRAINT_MUST_NOT_BE_CLASS_TYPE(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_NOT_BE_CLASS_FAILED< !pe::IsClass<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_NOT_BE_CLASS_TYPEDEF, __LINE__ )
//*************************************************************************************************
