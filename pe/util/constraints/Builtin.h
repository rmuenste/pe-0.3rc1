//=================================================================================================
/*!
 *  \file pe/util/constraints/Builtin.h
...
#ifndef _PE_UTIL_CONSTRAINTS_BUILTIN_H_
#define _PE_UTIL_CONSTRAINTS_BUILTIN_H_
 ...
 */
#define pe_CONSTRAINT_MUST_BE_BUILTIN_TYPE(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_BE_BUILTIN_TYPE_FAILED< pe::IsBuiltin<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_BE_BUILTIN_TYPE_TYPEDEF, __LINE__ )
//*************************************************************************************************
 ...
 */
#define pe_CONSTRAINT_MUST_NOT_BE_BUILTIN_TYPE(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_NOT_BE_BUILTIN_TYPE_FAILED< !pe::IsBuiltin<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_NOT_BE_BUILTIN_TYPE_TYPEDEF, __LINE__ )
//*************************************************************************************************
