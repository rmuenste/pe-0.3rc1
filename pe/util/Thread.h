...
#ifndef _PE_UTIL_THREAD_H_
#define _PE_UTIL_THREAD_H_
 ...
 *
 * The \b pe engine provides the functionality to create individual threads for specific tasks,
 ...
 * arguments are executed in parallel by two distinct threads:
   ...
   int main()
   {
      ...
      pe::Thread thread2( Functor2(), 4, 6 );
...
private:
   ...
   std::auto_ptr<boost::thread> thread_;      //!< Handle to the thread of execution.
   //@}
   //**********************************************************************************************
