...
#ifndef _PE_UTIL_TYPELIST_H_
#define _PE_UTIL_TYPELIST_H_
 ...
 * compile time, not at run time. The type list implementation of the \b pe physics engine
 * closely resembles the original implementation of Andrei Alexandrescu (taken from his book
 * Modern C++, ISBN: 0201704315). The following example demonstrates, how type lists are
 * created and manipulated:

   \code
   // Creating a type list consisting of two fundamental floating point data types
   typedef pe_TYPELIST_2( float, double )  Tmp;

   // Appending a type to the type list
   typedef pe::Append< Tmp, long double >::Result  Floats;  // Type list contained all floating point data types
   ...
   typedef pe::TypeAt< Floats, 0 >::Result  Index0;

   // Searching the type list for a specific type
   const int index1 = pe::Contains< Floats, double >::value;   // Value evaluates to 1
   const int index2 = pe::Contains< Floats, int    >::value;   // Value evaluates to 0

   // Estimating the index of a specific type in the type list
   const int index3 = pe::IndexOf< Floats, double >::value;    // Value evaluates to 1
   const int index4 = pe::IndexOf< Floats, int    >::value;    // Value evaluates to -1
   \endcode
 */
 ...
 * In order to create a type list, one of the predefined setup macros should be used:
   ...
   typedef pe_TYPELIST_3( float, double, long double )  Floats;
   \endcode
 */
 ...
 * macro:
   ...
   typedef pe_TYPELIST_2( int, unsigned int )  MyTypes;

   // Calculating the length of the type list
   const int length = Length<MyTypes>::value;
   \endcode
 */
#define pe_TYPELIST_2( T1, T2 ) \
   TypeList< T1, pe_TYPELIST_1( T2 ) >
//*************************************************************************************************
 ...
 * the use of this macro:
   ...
   typedef pe_TYPELIST_3( float, double, long double )  MyTypes;

   // Calculating the length of the type list
   const int length = Length<MyTypes>::value;
   \endcode
 */
#define pe_TYPELIST_3( T1, T2, T3 ) \
   TypeList< T1, pe_TYPELIST_2( T2, T3 ) >
//*************************************************************************************************
 ...
 * the use of this macro:
   ...
   typedef pe_TYPELIST_4( unsigned char, signed char, char, wchar_t )  MyTypes;

   // Calculating the length of the type list
   const int length = Length<MyTypes>::value;
   \endcode
 */
#define pe_TYPELIST_4( T1, T2, T3, T4 ) \
   TypeList< T1, pe_TYPELIST_3( T2, T3, T4 ) >
//*************************************************************************************************
 ...
 * demonstrates the use of this macro:
   ...
   typedef pe_TYPELIST_5( char, short, int, long, float )  MyTypes;

   // Calculating the length of the type list
   const int length = Length<MyTypes>::value;
   \endcode
 */
#define pe_TYPELIST_5( T1, T2, T3, T4, T5 ) \
   TypeList< T1, pe_TYPELIST_4( T2, T3, T4, T5 ) >
//*************************************************************************************************
 ...
 * demonstrates the use of this macro:
   ...
   typedef pe_TYPELIST_6( char, short, int, long, float, double )  MyTypes;

   // Calculating the length of the type list
   const int length = Length<MyTypes>::value;
   \endcode
 */
#define pe_TYPELIST_6( T1, T2, T3, T4, T5, T6 ) \
   TypeList< T1, pe_TYPELIST_5( T2, T3, T4, T5, T6 ) >
//*************************************************************************************************
 ...
 * following example demonstrates the use of this macro:
   ...
   typedef pe_TYPELIST_7( char, short, int, long, float, double, long double )  MyTypes;

   // Calculating the length of the type list
   const int length = Length<MyTypes>::value;
   \endcode
 */
#define pe_TYPELIST_7( T1, T2, T3, T4, T5, T6, T7 ) \
   TypeList< T1, pe_TYPELIST_6( T2, T3, T4, T5, T6, T7 ) >
//*************************************************************************************************
 ...
 * The following example demonstrates the use of this macro:
   ...
   typedef pe_TYPELIST_8( char, wchar_t, short, int, long, float, double, long double )  MyTypes;

   // Calculating the length of the type list
   const int length = Length<MyTypes>::value;
   \endcode
 */
#define pe_TYPELIST_8( T1, T2, T3, T4, T5, T6, T7, T8 ) \
   TypeList< T1, pe_TYPELIST_7( T2, T3, T4, T5, T6, T7, T8 ) >
//*************************************************************************************************
 ...
 * The following example demonstrates the use of this macro:
   ...
   typedef pe_TYPELIST_9( char, signed char, wchar_t, short, int, long, float, double, long double )  MyTypes;

   // Calculating the length of the type list
   const int length = Length<MyTypes>::value;
   \endcode
 */
#define pe_TYPELIST_9( T1, T2, T3, T4, T5, T6, T7, T8, T9 ) \
   TypeList< T1, pe_TYPELIST_8( T2, T3, T4, T5, T6, T7, T8, T9 ) >
//*************************************************************************************************
 ...
 * the NullType. The following example demonstrates the use of this macro:
   ...
   typedef pe_TYPELIST_10( unsigned char, signed char, char, wchar_t, unsigned short,
   ...
   \endcode
 */
#define pe_TYPELIST_10( T1, T2, T3, T4, T5, T6, T7, T8, T9, T10 ) \
   TypeList< T1, pe_TYPELIST_9( T2, T3, T4, T5, T6, T7, T8, T9, T10 ) >
//*************************************************************************************************
 ...
 * impression of the use of the Length class:
   ...
   \code
   typedef pe_TYPELIST_3( float, double, long double )  Floats;  // Defining a new type list
   const int length = pe::Length< Floats >::value;               // The length of the type list
   \endcode
 */
 ...
 * of the TypeAt class:
   ...
   \code
   typedef pe_TYPELIST_3( float, double, long double )  Floats;  // Defining a new type list
   typedef pe::TypeAt< Floats, 0 >::Result              Index0;  // Indexing of the type list at index 0
   \endcode
 ...
 * impression of the use of the ContainsRelated class:
   ...
   typedef pe_TYPELIST_2( A, C )  Types;

   // Searching for the type A in the type list
   const int a = pe::ContainsRelated< Types, A >::value;  // Evaluates to 1, type A is found

   // Searching for the derived type B in the type list
   const int b = pe::ContainsRelated< Types, B >::value;  // Evaluates to 1, base type A is found

   // Searching for the type C in the type list
   const int c = pe::ContainsRelated< Types, D >::value;  // Evaluates to 0, no related type found
   \endcode
 */
template< typename TList   // Type of the type list
        , typename Type >  // The search type
 ...
 * use of the IndexOf class:
   ...
   \code
   typedef pe_TYPELIST_3( float, double, long double )  Floats;  // Defining a new type list
   const int index1 = pe::IndexOf< Floats, double >::value;      // Value evaluates to 1
   const int index2 = pe::IndexOf< Floats, int    >::value;      // Value evaluates to -1
   \endcode
 */
template< typename TList   // Type of the type list
        , typename Type >  // The search type
 ...
 * class:
   ...
   \code
   typedef pe_TYPELIST_3( float, double )        Temp;    // Defining a temporary type list
   typedef pe::Append<Temp,long double>::Result  Floats;  // Type list contained all floating point data types
   \endcode
 */
template< typename TList   // Type of the type list
...
{
   //**Type definitions****************************************************************************
   typedef pe_TYPELIST_1( Type )  Result;  //!< The resulting data type.
   //**********************************************************************************************
};
/*! \endcond */
//*************************************************************************************************
