...
#ifndef _PE_UTIL_UNSIGNEDVALUE_H_
#define _PE_UTIL_UNSIGNEDVALUE_H_
...
#include <istream>
#include <ostream>
#include <pe/util/constraints/Unsigned.h>
...
private:
   ...
   //**Compile time checks*************************************************************************
   /*! \cond PE_INTERNAL */
   pe_CONSTRAINT_MUST_BE_UNSIGNED_TYPE( T );
   /*! \endcond */
   //**********************************************************************************************
};
//*************************************************************************************************
...
std::istream& operator>>( std::istream& is, UnsignedValue<T>& uv )
{
   ...
   // Transferring the input to the unsigned integer value
   uv = tmp;
