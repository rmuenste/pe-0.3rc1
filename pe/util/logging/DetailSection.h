//=================================================================================================
/*!
 *  \file pe/util/logging/DetailSection.h
...
#ifndef _PE_UTIL_LOGGING_DETAILSECTION_H_
#define _PE_UTIL_LOGGING_DETAILSECTION_H_
 ...
 * log file(s) in case the pe::loglevel has been set to \a detail or higher. The following
 * example demonstrates how this log section is used:
   ...
   int main( int argc, char** argv )
   {
      ...
      pe_LOG_DETAIL_SECTION( log ) {
         log << " Only printed within an active pe_LOG_DETAIL_SECTION!\n";
      }
 ...
 * Note that uncaught exceptions emitted from the pe::pe_LOG_DETAIL_SECTION might result in lost
 * and/or unlogged information!
 */
#define pe_LOG_DETAIL_SECTION( NAME ) \
   if( pe::logging::loglevel >= pe::logging::detail ) \
      if( pe::logging::LogSection NAME = pe::logging::detail )
//*************************************************************************************************
