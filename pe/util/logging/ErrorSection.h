//=================================================================================================
/*!
 *  \file pe/util/logging/ErrorSection.h
...
#ifndef _PE_UTIL_LOGGING_ERRORSECTION_H_
#define _PE_UTIL_LOGGING_ERRORSECTION_H_
 ...
 * the log file(s) in case the pe::loglevel has been set to \a error or higher. The following
 ...
 * Note that uncaught exceptions emitted from the pe::pe_LOG_ERROR_SECTION might result in lost
 * and/or unlogged information!
 */
#define pe_LOG_ERROR_SECTION( NAME ) \
   if( pe::logging::loglevel >= pe::logging::error ) \
      if( pe::logging::LogSection NAME = pe::logging::error )
//*************************************************************************************************
