//=================================================================================================
/*!
 *  \file pe/util/logging/WarningSection.h
...
#ifndef _PE_UTIL_LOGGING_WARNINGSECTION_H_
#define _PE_UTIL_LOGGING_WARNINGSECTION_H_
 ...
 * file(s) in case the pe::loglevel has been set to \a warning or higher. The following example
 ...
 * Note that uncaught exceptions emitted from the pe::pe_LOG_WARNING_SECTION might result in lost
 * and/or unlogged information!
 */
#define pe_LOG_WARNING_SECTION( NAME ) \
   if( pe::logging::loglevel >= pe::logging::warning ) \
      if( pe::logging::LogSection NAME = pe::logging::warning )
//*************************************************************************************************
