//=================================================================================================
/*!
 *  \file pe/util/valuetraits/IsPowerOf.h
...
#ifndef _PE_UTIL_VALUETRAITS_ISPOWEROF_H_
#define _PE_UTIL_VALUETRAITS_ISPOWEROF_H_
 ...
 * from \a FalseType.
   ...
   \code
   pe::IsPowerOf<2,8>::value   // Evaluates to 1 (2^3 = 8)
   pe::IsPowerOf<3,27>::value  // Evaluates to 1 (3^3 = 27)
   pe::IsPowerOf<5,1>::value   // Evaluates to 1 (5^0 = 1)
   pe::IsPowerOf<1,1>::Type    // Results in TrueType (1^x = 1)
   pe::IsPowerOf<0,0>          // Is derived from TrueType (0^x = 0)
   pe::IsPowerOf<2,14>::value  // Evaluates to 0
   pe::IsPowerOf<1,5>::value   // Evaluates to 0
   pe::IsPowerOf<0,5>::Type    // Results in FalseType
   pe::IsPowerOf<2,0>          // Is derived from FalseType
   \endcode
 */
