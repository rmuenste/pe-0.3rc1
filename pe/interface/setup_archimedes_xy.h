...
__attribute__((deprecated("setupArchimedesXY is deprecated and has no implementation")))
#elif defined(_MSC_VER)
__declspec(deprecated("setupArchimedesXY is deprecated and has no implementation"))
#endif
...
void setupArchimedesXY(MPI_Comm ex0)
{
   std::cerr << "WARNING: setupArchimedesXY() is deprecated and has no implementation.\n"
