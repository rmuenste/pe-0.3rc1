...
void setupArchimedes(MPI_Comm ex0)
{
   ...
   Vec3 pos1(-1.5, -2.4, 0.17);
   Vec3 pos2(-0.44, -2.8, 0.17);
   Vec3 pos3(0.55, -2.8, 0.1);
   Vec3 pos4(1.5, -2.5, 0.03);
   ...
   if (west[0] < 0)
   {
      ...
      pe_LOG_INFO_SECTION(log)
      {
         ...
         log << ") test point " << pos1 << theWorld()->ownsPoint(pos1) << "\n";
         log << ") test point " << pos2 << theWorld()->ownsPoint(pos2) << "\n";
         log << ") test point " << pos3 << theWorld()->ownsPoint(pos3) << "\n";
         log << ") test point " << pos4 << theWorld()->ownsPoint(pos4) << "\n";
      }
   }
   else
   {
