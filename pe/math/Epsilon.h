...
#ifndef _PE_MATH_EPSILON_H_
#define _PE_MATH_EPSILON_H_
 ...
 * \ingroup math
 *
 * The NegativeEpsilon class is a wrapper class around the functionality of the pe::Limits
 ...
 * \ingroup math
 *
 * The Epsilon class is a wrapper class around the functionality of the pe::Limits class.
 ...
 * In order to handle epsilon values conveniently, the global Epsilon instance pe::epsilon
 ...
 * \ingroup math
 *
 * The pe::epsilon instance can be used wherever a floating point data type is expected. It
 * is implicitly converted to the corresponding floating point data type and represents the
 * smallest possible difference between two values of the according data type.
 */
