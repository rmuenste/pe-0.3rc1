//=================================================================================================
/*!
 *  \file pe/math/sparse/MatrixAccessProxy.h
...
#ifndef _PE_MATH_SPARSE_MATRIXACCESSPROXY_H_
#define _PE_MATH_SPARSE_MATRIXACCESSPROXY_H_
 ...
 * this with two examples by means of the SparseMatrixMxN class:

   \code
   SparseMatrixMxN<real> A( 4, 4 );
...
{
   pe_INTERNAL_ASSERT( sm_.find( i_, j_ ) != sm_.end(i_), "Missing matrix element detected" );
}
//*************************************************************************************************
...
{
   const Iterator element( sm_.find( i_, j_ ) );
   pe_INTERNAL_ASSERT( element != sm_.end(i_), "Missing matrix element detected" );
