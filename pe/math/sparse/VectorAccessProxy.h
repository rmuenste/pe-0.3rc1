//=================================================================================================
/*!
 *  \file pe/math/sparse/VectorAccessProxy.h
...
#ifndef _PE_MATH_SPARSE_VECTORACCESSPROXY_H_
#define _PE_MATH_SPARSE_VECTORACCESSPROXY_H_
 ...
 * this with two examples by means of the SparseVectorN class:

   \code
   SparseVectorN<real> a( 5 );
...
{
   pe_INTERNAL_ASSERT( sv_.find( i_ ) != sv_.end(), "Missing vector element detected" );
}
//*************************************************************************************************
...
{
   const Iterator element( sv_.find( i_ ) );
   pe_INTERNAL_ASSERT( element != sv_.end(), "Missing vector element detected" );
