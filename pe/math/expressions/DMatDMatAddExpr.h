//=================================================================================================
/*!
 *  \file pe/math/expressions/DMatDMatAddExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_DMATDMATADDEXPR_H_
#define _PE_MATH_EXPRESSIONS_DMATDMATADDEXPR_H_
...
class DMatDMatAddExpr : public DenseMatrix< DMatDMatAddExpr<MT1,MT2> >
                      , private Expression
{
private:
   //**Type definitions****************************************************************************
...
public:
   ...
   typedef const DMatDMatAddExpr&                CompositeType;  //!< Data type for composite expression templates.
...
private:
   ...
   Rhs rhs_;  //!< Right-hand side dense matrix of the addition expression.
   //**********************************************************************************************
