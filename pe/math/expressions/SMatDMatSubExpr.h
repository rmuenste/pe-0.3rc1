//=================================================================================================
/*!
 *  \file pe/math/expressions/SMatDMatSubExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_SMATDMATSUBEXPR_H_
#define _PE_MATH_EXPRESSIONS_SMATDMATSUBEXPR_H_
...
class SMatDMatSubExpr : public DenseMatrix< SMatDMatSubExpr<MT1,MT2> >
                      , private Expression
{
private:
   //**Type definitions****************************************************************************
...
private:
   //**Member variables****************************************************************************
   Lhs lhs_;  //!< Left-hand side sparse matrix of the subtraction expression.
   ...
   */
   ...
   friend inline void assign( DenseMatrix<MT>& lhs, const SMatDMatSubExpr& rhs )
   {
      pe_INTERNAL_ASSERT( (~lhs).rows()    == rhs.rows()   , "Invalid number of rows"    );
      pe_INTERNAL_ASSERT( (~lhs).columns() == rhs.columns(), "Invalid number of columns" );
   ...
   */
   ...
   friend inline void assign( SparseMatrix<MT>& lhs, const SMatDMatSubExpr& rhs )
   {
   ...
   */
   template< typename MT >  // Type of the target dense matrix
   friend inline void addAssign( DenseMatrix<MT>& lhs, const SMatDMatSubExpr& rhs )
   {
      pe_INTERNAL_ASSERT( (~lhs).rows()    == rhs.rows()   , "Invalid number of rows"    );
      pe_INTERNAL_ASSERT( (~lhs).columns() == rhs.columns(), "Invalid number of columns" );
   ...
   /*! \cond PE_INTERNAL */
   /*!\brief Addition assignment of a sparse matrix-dense matrix subtraction to a sparse matrix.
   // \ingroup dense_matrix
   //
   // \param lhs The target left-hand side sparse matrix.
   // \param rhs The right-hand side subtraction expression to be added.
   ...
   */
   template< typename MT >  // Type of the target sparse matrix
   friend inline void addAssign( SparseMatrix<MT>& lhs, const SMatDMatSubExpr& rhs )
   {
      pe_CONSTRAINT_MUST_BE_DENSE_MATRIX_TYPE( ResultType );
      pe_CONSTRAINT_MUST_BE_REFERENCE_TYPE( typename ResultType::CompositeType );
   ...
   */
   template< typename MT >  // Type of the target dense matrix
   friend inline void subAssign( DenseMatrix<MT>& lhs, const SMatDMatSubExpr& rhs )
   {
      pe_INTERNAL_ASSERT( (~lhs).rows()    == rhs.rows()   , "Invalid number of rows"    );
      pe_INTERNAL_ASSERT( (~lhs).columns() == rhs.columns(), "Invalid number of columns" );
   ...
   /*! \cond PE_INTERNAL */
   /*!\brief Subtraction assignment of a sparse matrix-dense matrix subtraction to a sparse matrix.
   // \ingroup dense_matrix
   //
   // \param lhs The target left-hand side sparse matrix.
   // \param rhs The right-hand side subtraction expression to be subtracted.
   ...
   */
   template< typename MT >  // Type of the target sparse matrix
   friend inline void subAssign( SparseMatrix<MT>& lhs, const SMatDMatSubExpr& rhs )
   {
      pe_CONSTRAINT_MUST_BE_DENSE_MATRIX_TYPE( ResultType );
      pe_CONSTRAINT_MUST_BE_REFERENCE_TYPE( typename ResultType::CompositeType );
...
//*************************************************************************************************
/*!\brief Subtraction operator for the subtraction of a sparse matrix and a dense matrix
 *        (\f$ A=B+C \f$).
 * \ingroup dense_matrix
 *
 ...
 *
 * This operator represents the subtraction of a sparse matrix and a dense matrix:
