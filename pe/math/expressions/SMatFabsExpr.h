//=================================================================================================
/*!
 *  \file pe/math/expressions/SMatFabsExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_SMATFABSEXPR_H_
#define _PE_MATH_EXPRESSIONS_SMATFABSEXPR_H_
 ...
 *
 * \param sm The floating point sparse input matrix.
 * \return The absolute value of each single element of \a sm.
 *
 * The \a fabs function calculates the absolute value of each element of the sparse input
 * matrix \a sm.
 */
template< typename MT >  // Type of the sparse matrix
inline const MT fabs( const SparseMatrix<MT>& sm )
{
   using std::fabs;
