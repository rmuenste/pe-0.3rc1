//=================================================================================================
/*!
 *  \file pe/math/expressions/DVecSVecSubExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_DVECSVECSUBEXPR_H_
#define _PE_MATH_EXPRESSIONS_DVECSVECSUBEXPR_H_
...
public:
   ...
   typedef DVecSVecSubExpr<TT1,TT2,!TF>  TransposeType;
...
private:
   ...
   */
   ...
   /*! \cond PE_INTERNAL */
   /*!\brief Addition assignment of a dense vector-sparse vector subtraction to a sparse vector.
   // \ingroup dense_vector
   //
   // \param lhs The target left-hand side sparse vector.
   // \param rhs The right-hand side subtraction expression to be added.
   ...
   */
   template< typename VT >  // Type of the target sparse vector
   friend inline void addAssign( SparseVector<VT,TF>& lhs, const DVecSVecSubExpr& rhs )
   {
      pe_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE( ResultType );
      pe_CONSTRAINT_MUST_BE_VECTOR_WITH_TRANSPOSE_FLAG( ResultType, TF );
      pe_CONSTRAINT_MUST_BE_REFERENCE_TYPE( typename ResultType::CompositeType );
   ...
   */
   ...
   /*! \cond PE_INTERNAL */
   /*!\brief Subtraction assignment of a dense vector-sparse vector subtraction to a sparse vector.
   // \ingroup dense_vector
   //
   // \param lhs The target left-hand side sparse vector.
   // \param rhs The right-hand side subtraction expression to be subtracted.
   ...
   */
   template< typename VT >  // Type of the target sparse vector
   friend inline void subAssign( SparseVector<VT,TF>& lhs, const DVecSVecSubExpr& rhs )
   {
      pe_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE( ResultType );
      pe_CONSTRAINT_MUST_BE_VECTOR_WITH_TRANSPOSE_FLAG( ResultType, TF );
      pe_CONSTRAINT_MUST_BE_REFERENCE_TYPE( typename ResultType::CompositeType );
   ...
   */
   ...
   //**Addition assignment to sparse vectors*******************************************************
   /*! \cond PE_INTERNAL */
   /*!\brief Multiplication assignment of a dense vector-sparse vector subtraction to a sparse vector.
   // \ingroup dense_vector
   //
   // \param lhs The target left-hand side sparse vector.
   // \param rhs The right-hand side subtraction expression to be multiplied.
   ...
   */
   template< typename VT >  // Type of the target sparse vector
   friend inline void multAssign( SparseVector<VT,TF>& lhs, const DVecSVecSubExpr& rhs )
   {
      pe_CONSTRAINT_MUST_BE_DENSE_VECTOR_TYPE( ResultType );
      pe_CONSTRAINT_MUST_BE_VECTOR_WITH_TRANSPOSE_FLAG( ResultType, TF );
      pe_CONSTRAINT_MUST_BE_REFERENCE_TYPE( typename ResultType::CompositeType );
