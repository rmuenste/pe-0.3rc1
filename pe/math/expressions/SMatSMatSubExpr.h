//=================================================================================================
/*!
 *  \file pe/math/expressions/SMatSMatSubExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_SMATSMATSUBEXPR_H_
#define _PE_MATH_EXPRESSIONS_SMATSMATSUBEXPR_H_
...
//*************************************************************************************************
/*!\brief Subtraction operator for the subtraction of two sparse matrices (\f$ A=B+C \f$).
 ...
 *
 * This operator represents the subtraction of two sparse matrices:
...
const typename MathTrait<typename T1::ResultType,typename T2::ResultType>::SubType
   operator-( const SparseMatrix<T1>& lhs, const SparseMatrix<T2>& rhs )
{
   ...
   typedef typename MathTrait<R1,R2>::SubType    SubType;           // Subtraction result type
   ...
   pe_CONSTRAINT_MUST_BE_SPARSE_MATRIX_TYPE( SubType );
   ...
   SubType tmp( left.rows(), left.columns(), capacities );
