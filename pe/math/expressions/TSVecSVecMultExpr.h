//=================================================================================================
/*!
 *  \file pe/math/expressions/TSVecSVecMultExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_TSVECSVECMULTEXPR_H_
#define _PE_MATH_EXPRESSIONS_TSVECSVECMULTEXPR_H_
   ...
   operator*( const SparseVector<T1,true>& lhs, const SparseVector<T2,false>& rhs )
{
   ...
   typedef typename MathTrait<E1,E2>::MultType   MultType;       // Multiplication result type
   ...
   for( LeftIterator l=left.begin(); l!=lend && r!=rend; ++l ) {
