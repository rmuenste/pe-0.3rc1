//=================================================================================================
/*!
 *  \file pe/math/expressions/DMatAbsExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_DMATABSEXPR_H_
#define _PE_MATH_EXPRESSIONS_DMATABSEXPR_H_
...
class DMatAbsExpr : public DenseMatrix< DMatAbsExpr<MT> >
                  , private Expression
{
public:
   //**Type definitions****************************************************************************
   typedef MT                        ResultType;     //!< Result type for expression template evaluations.
   typedef const DMatAbsExpr&        CompositeType;  //!< Data type for composite expression templates.
 ...
 *
 * \param dm The integral input matrix.
 ...
 */
template< typename MT >  // Type of the dense matrix
inline const DMatAbsExpr<MT> abs( const DenseMatrix<MT>& dm )
{
   return DMatAbsExpr<MT>( ~dm );
}
//*************************************************************************************************
