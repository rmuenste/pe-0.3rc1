//=================================================================================================
/*!
 *  \file pe/math/expressions/SVecFabsExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_SVECFABSEXPR_H_
#define _PE_MATH_EXPRESSIONS_SVECFABSEXPR_H_
...
//*************************************************************************************************
/*!\brief Expression object for the sparse vector fabs() function.
 * \ingroup sparse_vector_expression
 *
 * The SVecFabsExpr class represents the compile time expression for the calculation of the
 * absolute value of each element of a sparse vector via the fabs() function.
 */
template< typename VT  // Type of the sparse vector
        , bool TF >    // Transposition flag
class SVecFabsExpr : public SparseVector< SVecFabsExpr<VT,TF>, TF >
                   , private Expression
{
private:
   //**Type definitions****************************************************************************
...
public:
   //**Type definitions****************************************************************************
   typedef SVecFabsExpr<VT,TF>       This;           //!< Type of this SVecFabsExpr instance.
   ...
   typedef const SVecFabsExpr&       CompositeType;  //!< Data type for composite expression templates.
   typedef SVecFabsExpr<TT,!TF>      TransposeType;  //!< Transpose type for expression template evaluations.
   ...
   */
   ...
   //**Constructor*********************************************************************************
   /*!\brief Constructor for the SVecFabsExpr class.
   */
   explicit inline SVecFabsExpr( const VT& sv )
      : sv_( sv )
   {}
   //**********************************************************************************************
 ...
 *
 * \param sv The floating point sparse input vector.
 * \return The absolute value of each single element of \a sv.
 *
 * The \a fabs function calculates the absolute value of each element of the sparse input vector
 ...
 * The following example demonstrates the use of the \a fabs function:
   ...
   \endcode
 */
template< typename VT  // Data type of the sparse vector
        , bool TF >    // Transposition flag
inline const SVecFabsExpr<VT,TF> fabs( const SparseVector<VT,TF>& sv )
{
   return SVecFabsExpr<VT,TF>( ~sv );
}
//*************************************************************************************************
