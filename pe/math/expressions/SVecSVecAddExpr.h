//=================================================================================================
/*!
 *  \file pe/math/expressions/SVecSVecAddExpr.h
...
#ifndef _PE_MATH_EXPRESSIONS_SVECSVECADDEXPR_H_
#define _PE_MATH_EXPRESSIONS_SVECSVECADDEXPR_H_
...
public:
   ...
   typedef SVecSVecAddExpr<TT1,TT2,!TF>          TransposeType;  //!< Transpose type for expression template evaluations.
...
private:
   //**Member variables****************************************************************************
   Lhs    lhs_;       //!< Left-hand side sparse vector of the addition expression.
   Rhs    rhs_;       //!< Right-hand side sparse vector of the addition expression.
   size_t nonzeros_;  //!< The number of non-zero elements in the sparse vector.
   //**********************************************************************************************

   //**Assignment to dense vectors*****************************************************************
   /*! \cond PE_INTERNAL */
   /*!\brief Assignment of a sparse vector-sparse vector addition to a dense vector.
   ...
   */
   ...
   friend inline void assign( DenseVector<VT,TF>& lhs, const SVecSVecAddExpr& rhs )
   {
      using boost::remove_reference;
   ...
   */
   ...
   /*! \cond PE_INTERNAL */
   /*!\brief Addition assignment of a sparse vector-sparse vector addition to a sparse vector.
   // \ingroup sparse_vector
   //
   // \param lhs The target left-hand side sparse vector.
   // \param rhs The right-hand side addition expression to be added.
   ...
   */
   template< typename VT >  // Type of the target dense vector
   friend inline void addAssign( SparseVector<VT,TF>& lhs, const SVecSVecAddExpr& rhs )
   {
      pe_INTERNAL_ASSERT( (~lhs).size() == rhs.size(), "Invalid vector sizes" );
   ...
   */
   ...
   /*! \cond PE_INTERNAL */
   /*!\brief Subtraction assignment of a sparse vector-sparse vector addition to a sparse vector.
   // \ingroup sparse_vector
   //
   // \param lhs The target left-hand side sparse vector.
   // \param rhs The right-hand side addition expression to be subtracted.
   ...
   */
   template< typename VT >  // Type of the target dense vector
   friend inline void subAssign( SparseVector<VT,TF>& lhs, const SVecSVecAddExpr& rhs )
   {
      pe_INTERNAL_ASSERT( (~lhs).size() == rhs.size(), "Invalid vector sizes" );
   ...
   */
   ...
   /*! \cond PE_INTERNAL */
   /*!\brief Multiplication assignment of a sparse vector-sparse vector addition to a sparse vector.
   // \ingroup sparse_vector
   //
   // \param lhs The target left-hand side sparse vector.
   // \param rhs The right-hand side addition expression to be multiplied.
   ...
   //
   // This function implements the performance optimized multiplication assignment of a sparse
   // vector-sparse vector addition expression to a sparse vector.
   */
   template< typename VT >  // Type of the target dense vector
   friend inline void multAssign( SparseVector<VT,TF>& lhs, const SVecSVecAddExpr& rhs )
   {
      pe_INTERNAL_ASSERT( (~lhs).size() == rhs.size(), "Invalid vector sizes" );
