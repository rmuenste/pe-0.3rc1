...
#ifndef _PE_MATH_ACCURACY_H_
#define _PE_MATH_ACCURACY_H_
 ...
 * \ingroup math
 *
 * The NegativeAccuracy class is a wrapper class around the functionality of the pe::Limits
 * class. It represents the negative computation accuracy of the physics engine for any floating
 ...
 * \ingroup math
 *
 * The Accuracy class is a wrapper class around the functionality of the pe::Limits class.
 * It represents the computation accuracy of the physics engine for any floating point data
 ...
 * In order to handle accuracy values conveniently, the global Accuracy instance pe::accuracy
 ...
 * \ingroup math
 *
 * The pe::accuracy instance can be used wherever a floating point data type is expected. It
 * is implicitly converted to the corresponding floating point data type and represents the
 * computation accuracy of the physics engine for the according data type.
 */
