...
#ifndef _PE_MATH_ROTATIONMATRIX_H_
#define _PE_MATH_ROTATIONMATRIX_H_
...
class RotationMatrix : public DenseMatrix< RotationMatrix<Type> >
{
public:
   //**Type definitions****************************************************************************
   ...
   */
   //@{
   template< typename Other >
   inline const Matrix3x3< typename MathTrait<Type,Other>::MultType > rotate( const Matrix3x3<Other>& m ) const;

   template< typename Other >
   inline const Matrix3x3< typename MathTrait<Type,Other>::MultType > diagRotate( const Matrix3x3<Other>& m ) const;
   //@}
   //**********************************************************************************************
...
{
   pe_CONSTRAINT_MUST_BE_FLOATING_POINT_TYPE( Axis );

   pe_USER_ASSERT( ( axis.sqrLength() > Axis(0) || angle == Type(0) ), "Invalid matrix parameters" );
...
{
   pe_USER_ASSERT( index < 9, "Invalid rotation matrix access index" );
   return v_[index];
}
//*************************************************************************************************
...
{
   pe_USER_ASSERT( i<3 && j<3, "Invalid rotation matrix access index" );
   return v_[i*3+j];
}
//*************************************************************************************************
...
inline const Matrix3x3< typename MathTrait<Type,Other>::MultType >
   RotationMatrix<Type>::rotate( const Matrix3x3<Other>& m ) const
{
   ...
   const Matrix3x3<MT> tmp( m.v_[0]*v_[0] + m.v_[1]*v_[1] + m.v_[2]*v_[2],
   ...
   return Matrix3x3<MT>( v_[0]*tmp.v_[0] + v_[1]*tmp.v_[3] + v_[2]*tmp.v_[6],
   ...
   /*
   return Matrix3x3<MT>( m.v_[0]*v_[0]*v_[0] + m.v_[4]*v_[1]*v_[1] + m.v_[8]*v_[2]*v_[2] + v_[0]*v_[1]*( m.v_[1]+m.v_[3] ) + v_[0]*v_[2]*( m.v_[2]+m.v_[6] ) + v_[1]*v_[2]*( m.v_[5]+m.v_[7] ),
...
inline const Matrix3x3< typename MathTrait<Type,Other>::MultType >
   RotationMatrix<Type>::diagRotate( const Matrix3x3<Other>& m ) const
{
   pe_CONSTRAINT_MUST_BE_FLOATING_POINT_TYPE( Other );
   ...
   const Matrix3x3<MT> tmp( m.v_[0]*v_[0], m.v_[0]*v_[3], m.v_[0]*v_[6],
...
template< typename Type >
inline const Matrix3x3<Type> abs( const RotationMatrix<Type>& m );

template< typename Type >
inline const Matrix3x3<Type> fabs( const RotationMatrix<Type>& m );
...
inline const Vector3< typename MathTrait<T1,T2>::MultType, false >
   operator*( const RotationMatrix<T1>& lhs, const Vector3<T2,false>& rhs );
...
inline const Matrix3x3< typename MathTrait<T1,T2>::MultType >
   operator*( const RotationMatrix<T1>& lhs, const Matrix3x3<T2>& rhs );

template< typename T1, typename T2 >
inline const Matrix3x3< typename MathTrait<T1,T2>::MultType >
   operator*( const Matrix3x3<T1>& lhs, const RotationMatrix<T2>& rhs );
...
/*! \cond PE_INTERNAL */
template< typename T1, typename T2 >
struct MathTrait< RotationMatrix<T1>, Vector3<T2,false> >
{
...
template< typename T1, typename T2 >
struct MathTrait< Vector3<T1,true>, RotationMatrix<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                                HighType;
   typedef INVALID_NUMERICAL_TYPE                                LowType;
   typedef INVALID_NUMERICAL_TYPE                                AddType;
...
template< typename T1, typename T2 >
struct MathTrait< RotationMatrix<T1>, VectorN<T2,false> >
{
   typedef INVALID_NUMERICAL_TYPE                                 HighType;
   typedef INVALID_NUMERICAL_TYPE                                 LowType;
   typedef INVALID_NUMERICAL_TYPE                                 AddType;
...
template< typename T1, typename T2 >
struct MathTrait< VectorN<T1,true>, RotationMatrix<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                                HighType;
   typedef INVALID_NUMERICAL_TYPE                                LowType;
   typedef INVALID_NUMERICAL_TYPE                                AddType;
...
template< typename T1, typename T2 >
struct MathTrait< RotationMatrix<T1>, SparseVectorN<T2,false> >
{
   typedef INVALID_NUMERICAL_TYPE                                 HighType;
   typedef INVALID_NUMERICAL_TYPE                                 LowType;
   typedef INVALID_NUMERICAL_TYPE                                 AddType;
...
template< typename T1, typename T2 >
struct MathTrait< SparseVectorN<T1,true>, RotationMatrix<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                                HighType;
   typedef INVALID_NUMERICAL_TYPE                                LowType;
   typedef INVALID_NUMERICAL_TYPE                                AddType;
...
template< typename T1, typename T2 >
struct MathTrait< RotationMatrix<T1>, Matrix3x3<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                            HighType;
   typedef INVALID_NUMERICAL_TYPE                            LowType;
   typedef INVALID_NUMERICAL_TYPE                            AddType;
...
template< typename T1, typename T2 >
struct MathTrait< Matrix3x3<T1>, RotationMatrix<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                            HighType;
   typedef INVALID_NUMERICAL_TYPE                            LowType;
   typedef INVALID_NUMERICAL_TYPE                            AddType;
...
template< typename T1, typename T2 >
struct MathTrait< RotationMatrix<T1>, MatrixMxN<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                            HighType;
   typedef INVALID_NUMERICAL_TYPE                            LowType;
   typedef INVALID_NUMERICAL_TYPE                            AddType;
...
template< typename T1, typename T2 >
struct MathTrait< MatrixMxN<T1>, RotationMatrix<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                            HighType;
   typedef INVALID_NUMERICAL_TYPE                            LowType;
   typedef INVALID_NUMERICAL_TYPE                            AddType;
...
template< typename T1, typename T2 >
struct MathTrait< RotationMatrix<T1>, SparseMatrixMxN<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                            HighType;
   typedef INVALID_NUMERICAL_TYPE                            LowType;
   typedef INVALID_NUMERICAL_TYPE                            AddType;
...
template< typename T1, typename T2 >
struct MathTrait< SparseMatrixMxN<T1>, RotationMatrix<T2> >
{
   typedef INVALID_NUMERICAL_TYPE                            HighType;
   typedef INVALID_NUMERICAL_TYPE                            LowType;
   typedef INVALID_NUMERICAL_TYPE                            AddType;
