//=================================================================================================
/*!
 *  \file pe/math/problems/MixedLCP.h
...
#ifndef _PE_MATH_PROBLEMS_MIXEDLCP_H_
#define _PE_MATH_PROBLEMS_MIXEDLCP_H_
...
struct MixedLCP
{
   ...
   //@{
   SMatN A11_;  //!< The upper left part of the system matrix \f$ A_{11} \f$.
   SMatN A12_;  //!< The upper right part of the system matrix \f$ A_{12} \f$.
   SMatN A21_;  //!< The lower left part of the system matrix \f$ A_{21} \f$.
   SMatN A22_;  //!< The lower right part of the system matrix \f$ A_{22} \f$.
