//=================================================================================================
/*!
 *  \file pe/math/constraints/SparseVector.h
...
#ifndef _PE_MATH_CONSTRAINTS_SPARSEVECTOR_H_
#define _PE_MATH_CONSTRAINTS_SPARSEVECTOR_H_
 ...
 * error is created.
 */
#define pe_CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE_FAILED< IsSparseVector<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_BE_SPARSE_VECTOR_TYPE_TYPEDEF, __LINE__ )
//*************************************************************************************************
 ...
 * error is created.
 */
#define pe_CONSTRAINT_MUST_NOT_BE_SPARSE_VECTOR_TYPE(T) \
   typedef \
      pe::CONSTRAINT_TEST< \
         pe::CONSTRAINT_MUST_NOT_BE_SPARSE_VECTOR_TYPE_FAILED< !IsSparseVector<T>::value >::value > \
      pe_JOIN( CONSTRAINT_MUST_NOT_BE_SPARSE_VECTOR_TYPE_TYPEDEF, __LINE__ )
//*************************************************************************************************
