...
static const char* const solverRationale =
   "mpiperiodic_dev is pure rigid body physics; its contact and damping parameters are\n"
...
int main( int argc, char** argv )
{
   ...
   if( !pe::examples::requireIntendedSolver<TargetConfig2, TargetConfig3>(
          "mpiperiodic_dev", intendedSolvers, solverRationale ) ) {
      MPI_Finalize();
      return EXIT_FAILURE;
   }
